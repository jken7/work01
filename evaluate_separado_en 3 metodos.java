	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			//Map que tendrá toda la estructura del reporte.
			...
			while (elemGrupos != null){
				...
				while (elemMarca!= null) {
					 ...
					 * */
						...
						procesarTipoMarcaTABLE(eleTipoMarca,elemModelo,eleMarca_idMarca,mapGeneral);
	...
	public void procesarTipoMarcaTABLE(MbElement eleTipoMarca, MbElement elemModelo, MbElement eleMarca_idMarca,Map mapGeneral) throws MbException{
		...
		if (elemTagTableHeader != null) {
			...
			if (elemTagTableBody != null) {
				...
				while (elemTagTableRow != null) {
					procesarElemTagTableRow(elemTagTableRow,elemTagText,auxList,elemTagTableHeader,contadorFolios,indAgregarListaToMap);
	...
	public void procesarElemTagTableRow(MbElement elemTagTableRow,MbElement elemTagText,List auxList,MbElement elemTagTableHeader,
			Integer contadorFolios,Boolean indAgregarListaToMap) throws MbException{
